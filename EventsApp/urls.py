...
urlpatterns = [
    ...
    path('individual/profile_submit/', views.user_profile_submit, name='user_profile_submit'),
    ...
    path('switch_profile/<str:name>/',
         views.switch_profile, name='switch_profile'),
    path('delete_current_profile/', views.delete_current_profile,
         name='delete_current_profile'),
    # path('<int:event_id>/', views.event_by_id, name='event_by_id'),
    path('invite/<int:event_id>/', views.invite_by_id, name='invite_by_id'),
    path('invite/<int:event_id>/<str:email>/',
         views.invite_by_id, name='invite_by_id'),
    path('invite/', views.invite, name='invite'),
    path('delete/<int:event_id>/<str:date>/',
         views.delete_by_id, name='delete_by_id'),
    path('get_selected_sports_type/', views.get_selected_sports_type,
         name='get_selected_sports_type'),
    path('get_sports_type/', views.get_sports_type, name='get_sports_type'),
    path('get_sports_skill/', views.get_selected_sports_skill,
         name='get_selected_sports_skill'),
    path('get_sports_position/', views.get_selected_sports_positions,
         name='get_selected_sports_positions'),
    ...
    path('add_sports_positions/', views.add_sports_positions,
    ...
    path('add_user_locations/', views.add_user_locations,
         name='add_user_locations'),
    path('fetch_user_locations/', views.fetch_user_locations,
    ...
    path('add_availability/', views.add_availability, name='add_availability'), # TODO : Check why this was deleted in master
    path('add_organization_locations/', views.add_organization_locations,
         name='add_organization_locations'),
    path('fetch_organization_locations/', views.fetch_organization_locations,
         name='fetch_organization_locations'),
    path('get_organization_timings/', views.get_organization_timings,
         name='get_organization_timings'),
    path('get_user_availability/', views.get_user_availability,

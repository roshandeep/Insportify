...
urlpatterns = [
    ...
    path('switch_profile/<str:name>/', views.switch_profile, name='switch_profile'),
    path('delete_current_profile/', views.delete_current_profile, name='delete_current_profile'),

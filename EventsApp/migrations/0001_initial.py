# Generated by Django 3.2.12 on 2023-02-28 05:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Individual',
            fields=[
                ('profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='EventsApp.profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill', models.CharField(blank=True, max_length=30, null=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='EventsApp.profile')),
            ],
        ),
        migrations.AddField(
            model_name='profile',
            name='active_user',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ActiveProfile', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='profile',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='EventsApp.profile')),
        ...
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='EventsApp.profile'),
        ),
        migrations.CreateModel(
            name='Invite',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geographical_scope', models.CharField(blank=True, choices=[('Local', 'Local'), ('Provincial', 'Provincial'), ('National', 'National')], max_length=100, null=True)),
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='EventsApp.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Logo',
            fields=[
                ...
                ('individual', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='EventsApp.individual')),
            ],
        ),
    ]
